...
public class Es1 {
    ...
    private static void exercise1() {
        ...
        Set<Integer> ourSet = new LinkedHashSet<>();
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [5 strings]
        ...
        //2b. What will this output? [a sum of string for fruitsSet and fruitList ]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        Set<Integer> itemsContainedInBothSets = new HashSet<>();
            ...
            for (Integer items2 : setB) {
                if (setA.contains(items2)){
                  itemsContainedInBothSets.add(items2);
                }
            }
