...
public class Es10Exercises {public static void main(String[] args) {
    exercise1();
    exercise2();
}
    /**
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Person persona1 = new Person("Gabriele",24,"asdf");
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Person persona1 = new Person("Gabriele",24,"prap");
        Person persona2 = new Person("Anna",22,"asnagdur");
