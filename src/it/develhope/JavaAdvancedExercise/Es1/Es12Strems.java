...
public class Es12Strems {public static void main(String[] args) {
    exercise1();
    exercise2();
    exercise3();
    exercise4();
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        ourNumbers.stream().filter(x -> x % 2 != 0).collect(Collectors.toSet()).forEach(System.out::println);
    ...
    private static void exercise3() {
        ...
        // Your code here
        alice.stream().map(x -> x.toUpperCase()).collect(Collectors.toSet()).forEach(System.out::println);
    }
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        ourNumbers.stream().filter(x -> x % 2 == 0).map(x -> x * 2).collect(Collectors.toSet()).forEach(System.out::println);
