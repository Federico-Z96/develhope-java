...
public class es6 {public static void main(String[] args) {
    exercise1();
    exercise2();
    exercise3();
    exercise4();
    ...
    private static void exercise1() {
        ...
        String playlist = "Michael Jackson, Queen and Rolling Stone";

        System.out.println( playlist.toLowerCase());
        System.out.println( playlist.toUpperCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Michelle";
        String lastName = "Nardo";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 10 + 2.75; // <--- Edit this line
